...
export class Options {
  ...
  path_filters: PathFilter
  system_message: string
  gemini_model: string // Renamed
  gemini_model_temperature: number // Renamed
  gemini_retries: number // Renamed
  gemini_concurrency_limit: number // Renamed
  max_tokens_for_extra_content: number
  ...
  constructor(
    ...
    path_filters: string[] | null = null,
    system_message = '',
    gemini_model = 'gemini-1.5-flash', // Default to a modern, fast model
    gemini_model_temperature = '0.7',
    gemini_retries = '3',
    gemini_concurrency_limit = '4'
  ) {
    this.debug = debug
    this.max_files = parseInt(max_files)
    this.review_comment_lgtm = review_comment_lgtm
